...
for sims = 1:nsims
    ...
    clearvars -except n_trials nsubs nsims trans_prob prob_market_shuffle eta_values beta_values w_values sims stats_dependent_flexible stats_independent_flexible
    ...
    stats_dependent_flexible.stat_comp_estimate(sims, :) = m1.Coefficients.Estimate(2:end)';
    stats_dependent_flexible.stat_comp_tstat(sims, :) = m1.Coefficients.tStat(2:end)';
    stats_dependent_flexible.stat_comp_pval(sims, :) = m1.Coefficients.pValue(2:end)';
    stats_dependent_flexible.stat_SE(sims,:) = m1.Coefficients.SE(2:end);
    
    %save all the relevant results in a struct for independent blocks
    stats_independent_flexible.stat_comp_estimate(sims, :) = m2.Coefficients.Estimate(2:end)';
    stats_independent_flexible.stat_comp_tstat(sims, :) = m2.Coefficients.tStat(2:end)';
    stats_independent_flexible.stat_comp_pval(sims, :) = m2.Coefficients.pValue(2:end)';
    stats_independent_flexible.stat_SE(sims,:) = m2.Coefficients.SE(2:end);
    
end

% save 'stats_dependent_flexible.mat'
% writematrix(stats_dependent_flexible.stat_comp_estimate, 'stats_dependent_estimates_sims_flexible.csv');
% 
% save 'stats_independent_flexible.mat'
% writematrix(stats_independent_flexible.stat_comp_estimate, 'stats_independent_estimates_sims_flexible.csv');
